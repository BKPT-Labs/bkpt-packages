...
Copies the embedded recorder trees (core/, freertos/, zephyr/) from the
ViewAlyzer source repo into
...
# Embedded-target trees only; anything else in the recorder dir never
# ships to firmware projects.
